    ...
    <v-table height="300px" class="w-75" fixed-header>
      ...
      <tbody>
        <tr class="text-subtitle-1" v-for="interview in interviews" :key="interview.id">
          ...
          <v-btn icon="mdi-location-enter" @click="takeToInterview(interview.id)"></v-btn>
        </tr>
      </tbody>
    </v-table>
  </div>
